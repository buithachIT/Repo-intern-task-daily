...
export const signupFormSchema = z
  .object({
    firstName: z.string({ required_error: 'required field' }).min(1, { message: 'required field' }),
    lastName: z.string({ required_error: 'required field' }).min(1, { message: 'required field' }),
    email: z
      .string({
